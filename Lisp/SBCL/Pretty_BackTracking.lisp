...
;;;If we want to print pretty back trace print we need to add following code in common lisp.
...
;;;;=============
;;After That when we want to use that we need following code to utilise it
;;;;=============
...
;;;;This will print Pretty Backtrace which is plesent than original bktrace. 
